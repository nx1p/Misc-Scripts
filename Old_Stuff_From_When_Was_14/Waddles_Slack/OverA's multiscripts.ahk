...
msgbox OverA's multiscripts |BEFORE USING THE SCRIPT RIGHT CLICK EDIT AND REPLACE "HERE" WITH YOUR CSGO SENSITIVITY| F1 to toggle bhop | F2 is panic button (turn off whole script) | F3 to see all the RCS buttons | Hold mouse3 (scroll wheel button) to use rapid fire (Left Alt+Mouse3 to toggle on/off)  |And don't forget to type m_rawinput 1 in the console!


;Settings.Replace the both HERE and write your csgo zoomsensitivity and your csgo sensitivity
sens:=HERE
zoomsens:=HERE


;Key binds,if changed the RCS list menu would be wrong.Hold Left ALT when zoomed in with AUG/SG553
key_AK:="F4"
key_M4A1:="F6"
key_M4A4:="F7"
key_Famas:="F8"
...
F3::msgbox |Ak-47=F4|M4A1-S=F6|M4A4=F7|Famas=F8|Galil=F9|UMP=F12|AUG=Home|SG553=End|RCS off=F11|
